...
public class GuideBook implements IGuideBook {
    ...
    private static @NotNull Map<ResourceLocation, EntryAbstract> buildItems(@NotNull BookHelper helper) {
        ...
        helper.info(ModItems.PURE_SALT.get()).setLinks(VResourceLocation.mod("guide.vampirism.items.holy_water_bottle")).setFormats(loc(ModItems.PURE_SALT.get()), loc(ModItems.PURE_SALT.get()), loc(ModBlocks.ALCHEMICAL_CAULDRON.get())).recipes("pure_salt").build(entries);
    ...
    private static @NotNull Map<ResourceLocation, EntryAbstract> buildBlocks(@NotNull BookHelper helper) {
        ...
        helper.info(ModBlocks.GARLIC_DIFFUSER_NORMAL.get(), ModBlocks.GARLIC_DIFFUSER_WEAK.get(), ModBlocks.GARLIC_DIFFUSER_WEAK.get()).setFormats(cn, cn, ce, ce, loc(ModItems.PURIFIED_GARLIC.get())).useCustomEntryName().setKeyName("garlic_diffuser").setLinks(VResourceLocation.mod("guide.vampirism.blocks.garlic"), VResourceLocation.mod("guide.vampirism.items.purified_garlic"), VResourceLocation.mod("guide.vampirism.items.holy_water_bottle")).recipes("hunter/garlic_diffuser_normal", "hunter/garlic_diffuser_improved", "garlic_diffuser_core", "garlic_diffuser_core_improved").build(entries);
